...
export const site = {
  ...
  about:
    'I’m Kenneth — designer and director in LA. Twenty years making things move, mostly motion and 3D.',
  ...
  skills: [
    ...
    { group: 'AI & Generative', items: ['Higgsfield', 'KREA', 'Figma Weave', 'Midjourney', 'Luma', 'AI Workflows & Pipelines'] },
